 ...
 * 
 * <p>Java class for InvoiceRequestType complex type</p>.
 * 
    ...
    extends TaxTransactionRequestType
{
    ...
    /**
     * The Seller for the transaction. The Seller is described by the child
     *                                 elements and attributes. Required (1) at either the Transaction level or the Line Item
     *                                 level. If information is provided at both levels, the Line Item level information
     *                                 supersedes the Transaction level information.
     * 
     */
    @XmlElement(name = "Seller")
    protected SellerType seller;
    /**
     * The Customer for the transaction. The Customer is described by the child
    ...
    /**
     * The header for a component of a transaction. A line item is required for
     *                                 each component of the transaction. Each transaction requires at least one line item.
     *                                 Note that a line item can contain child line items.
     * 
     */
