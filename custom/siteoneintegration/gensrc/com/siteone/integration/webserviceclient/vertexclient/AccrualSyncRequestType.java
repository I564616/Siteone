 ...
 * 
 * <p>Java class for AccrualSyncRequestType complex type</p>.
 * 
    ...
    extends TaxSynchronizationRequestType
{
    ...
    /**
     * The buyer for the transaction. The buyer is described by the child
    ...
    /**
     * The vendor for the transaction. The vendor is described by the child
     *                                 elements and attributes.
     * 
     */
    ...
    /**
     * This value is used when the buyer has paid a portion of the tax due on the invoice but an
     *                 undercharge scenario occurs that required a partial accrual of tax or additional use tax may be due
     *                 depending on the jurisdiction and usage of the Purchase. The amount paid from the invoice verification
     *                 process should be passed so that partial accrual can be applied. Additional consumer use tax will be
    ...
    /**
     * The header for a component of a transaction. Note that a line item can
     *                                 contain child line items.
     * 
     */
    ...
    /**
     * Indicates the type of business transaction to be posted. This field is on the
     *                     transaction level.
     * 
     */
    ...
    /**
     * Indicates the billing documents that specify different business transactions that are
     *                     involved in billing activities. Examples of billing documents include invoice, credit or debit memo,
     *                     or cancellation document. This field is on the transaction level.
     * 
     */
    @XmlAttribute(name = "billingType")
    protected String billingType;
    /**
     * The key that identifies the purpose of the order. This field is on the transaction
     *                     level.
     * 
     */
    ...
    /**
     * The date when the transaction is posted for auditing and reporting purposes. If no
     *                     date is provided, the Calculation Engine uses the date when the transaction was processed.
     * 
     */
    ...
    /**
     * A value that can be used for tax return filing in jurisdictions that require taxes to
     *                     be filed for individual retail locations.
     * 
     */
    @XmlAttribute(name = "locationCode")
    protected String locationCode;
    /**
     * Indicates whether the response message should contain an additional structure that
     *                     shows the elements/attributes that were changed by Tax Assist. This is for informational purposes
     *                     only and contains no tax results.
     * 
     */
     ...
     *                     generated by the Tax Assist allocation feature. Otherwise, these line items are deleted after the
     *                     transaction is written to the Tax Journal and only the primary line item, which contains the
     *                     combined tax results of the child line items, is passed back to the host system.
     * 
     */
    @XmlAttribute(name = "returnGeneratedLineItemsIndicator")
    protected Boolean returnGeneratedLineItemsIndicator;
    /**
     * An identifier that determines the vendor or customer jurisdiction in which the title
     *                     transfer of a supply takes place. This is also known as Shipping Terms. Delivery Terms information
     *                     could be critical to determine the place of supply, for example, in distance selling.
     * 
     */
    @XmlAttribute(name = "deliveryTerm")
    protected DeliveryTermCodeType deliveryTerm;
    /**
     * The actual date of the requested action. The calculation engine uses this date to
     *                     determine the valid tax rates and rules.
     * 
     */
    ...
    /**
     * An identifier that further defines the document and corresponds to the transaction
     *                     stored in the host system. The Transaction ID is used for synchronization services, but is not used
    ...
    /**
     * An identifier for the specific transaction type to be used by the transaction and/or
     *                     line item. If transactionType is not set at the line item level, the line item uses the transaction
     *                     level value.
     * 
     */
    ...
    /**
     * The roundAtLineLevel attribute enables you to apply line-item level or invoice-level
     *                     rounding to tax calculations. Set this attribute to True to set up line-item level rounding. With
     *                     line-item level rounding, the Calculation Engine rounds amounts at the line-item level and then sums
     *                     those amounts to calculate an invoice total. This method is useful for invoices that include line
     *                     items with different taxing jurisdictions.
     * 
     *                     The default value for this attribute is False. In this case, O Series applies an invoice-level
     *                     rounding, where the Calculation Engine compares the sum of rounded line item-level totals to the
     *                     rounded invoice-level total. When there is a difference between these totals, the Calculation Engine
     *                     compares differences between rounded and unrounded amounts at each jurisdiction level and
     *                     distributes the difference to the jurisdiction that results in the smallest total rounding
     *                     difference amount. For more information about invoice-level rounding, contact Vertex Product Support
     *                     to obtain the Rounding Guide.
     * 
     */
    @XmlAttribute(name = "roundAtLineLevel")
    protected Boolean roundAtLineLevel;
    /**
     * The date the purchaser paid for the product. If the purchaser pays for the product
     *                     but physically receives it at a later date, Vertex O Series uses this field for returns and
     *                     reporting for your tax type. This field is also used in cash accounting.
     * 
     */
    ...
    /**
     * Supports reporting and the document sequence identifier used by your ERP system. Some
     *                     countries require that documents follow a unique sequential sequence number, depending on the
     *                     registration type and the type of invoice. Use this field for audit purposes to track the sequence
     *                     of your documents. This field is used in European Union (EU) countries.
     * 
     */
    @XmlAttribute(name = "documentSequenceId")
    protected String documentSequenceId;
    /**
     * The date that drives the timing of when the VAT liability arises. In some countries,
     *                     if the Tax Point Date, (also called the Time of Supply) is different from the invoice date, this
     *                     field is shown separately on an invoice. Use this field if you have reporting compliance in Spain,
     *                     Poland, and Hungary.
     * 
     */
     ...
     *     {@link TaxabilityCategoryTotals }
     *     
     * @see #getTaxabilityCategoryTotals()
     */
