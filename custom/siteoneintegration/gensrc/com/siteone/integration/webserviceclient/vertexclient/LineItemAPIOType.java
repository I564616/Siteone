 ...
 * 
 * <p>Java class for LineItemAPIOType complex type</p>.
 * 
...
public class LineItemAPIOType {
    ...
    /**
     * The Unit Price is used in conjunction with the quantity to calculate an extended price, if one is not provided.
     * 
     */
    ...
    /**
     * When difference between the line-item tax amount and the charged tax amount exceeds the threshold specified in the Vertex Central user interface.
     * 
     */
    @XmlElement(name = "OutsideThreshold")
    protected Boolean outsideThreshold;
    /**
     * Difference between total tax on invoice and the Vertex calculated amount. This amount can be used as the amount of tax to be partially accrued as Consumer's Use Tax.
     * 
     */
    ...
    /**
     * An identifier that determines the point in which the title transfer and risk of a supply takes place. A Delivery Term Code identifies the importer of record on cross-border transactions. These terms are also known as Shipping Terms or Incoterm. Delivery Term information is critical in Value Added Tax transactions to determine the place of supply, for example, in distance selling. For detailed explanations of these terms, refer to the Terms of Sales definition in the glossary of the U.S. Department of Transportation Maritime
