 ...
 * 
 * <p>Java class for LineItemASIType complex type</p>.
 * 
...
public class LineItemASIType {
    ...
    /**
     * The buyer for the line item. The buyer is described by the child elements and
     *                         attributes.
     * 
     */
    ...
    /**
     * The vendor for the line item. The vendor is described by the child elements and
     *                         attributes.
     * 
     */
    ...
    /**
     * Information necessary for the calculation of recoverability of an input tax.
     * 
     */
    ...
    /**
     * The type of synchronization service to be performed.
     * 
     */
    @XmlAttribute(name = "syncType", required = true)
    protected SyncronizationCodeType syncType;
    /**
     * A line number for the line item. This number can be used as a reference in reports or
     *                     in audits. If no line item number is supplied, a number will be assigned.
     * 
     */
    @XmlAttribute(name = "lineItemNumber")
    protected Long lineItemNumber;
    /**
     * The date on which the line item record was produced. This can also be represented as
     *                     a PO line item date, a lease line item date, and so on. Defaults to the documentDate of the
     *                     transaction.
     * 
     */
    ...
    /**
     * An identifier that further defines the line item and corresponds to the transaction
     *                     stored in the host system. This parameter is needed to perform synchronization services, but it is
    ...
    /**
     * Indicates whether the calculation engine calculates component-level max tax, where
     *                     applicable. Amounts at the child level of the multi-component item are used for tax calculation.
     *                     Amounts at the parent level are ignored. Set this attribute to true for line items at the parent
     *                     level only. Line items at the child level remain false. Defaults to false.
     * 
     */
    ...
    /**
     * A value that indicates a specific area of an organization generally related to
     *                     functional or accounting areas.
     * 
     */
    @XmlAttribute(name = "costCenter")
    protected String costCenter;
    /**
     * A unique identifier that associates a line item to a department for purchasing
     *                     purposes.
     * 
     */
    ...
    /**
     * A unique identifier that associates a line item to a project for purchasing
     *                     purposes.
     * 
     */
    ...
    /**
     * The 3-digit ISO 3166 code of the country where the product was produced or
     *                     manufactured.
     * 
     */
    ...
    /**
     * A code that indicates the type of vehicle that transported the product across the
     *                     country border. For a list of acceptable values, see the filing instructions for each country where
     *                     you file an Intrastat report.
     * 
     */
    @XmlAttribute(name = "modeOfTransport")
    protected Integer modeOfTransport;
    /**
     * A code that indicates the type of transaction being declared for Intrastat purposes.
     *                     For a list of acceptable values, see the filing instructions for each country where you file an
     *                     Intrastat report.
     * 
     */
    ...
    /**
     * Used to classify the goods and services. For a list of acceptable values, see the
     *                     filing instructions for each country where you file an Intrastat report.
     * 
     */
    ...
    /**
     * A contractual term indicating where the title to goods actually changes hands from
     *                     seller to buyer. This indicator is evaluated to determine the situs (or place of supply) for the
     *                     transaction.
     * 
     */
    ...
    /**
     * Identifies a phase within a series of transactions in which multiple invoices are
     *                     raised with only a single movement of goods.
     * 
     */
    ...
    /**
     * The material origin type. Material Origin applies to countries, such as Brazil and
     *                     India, where taxation can vary based on where the goods were acquired before sale.
     * 
     */
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the inputTax property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the inputTax property.
     */
    public List<InputTax> getInputTax() {
        if (inputTax == null) {
            inputTax = new ArrayList<>();
        }
