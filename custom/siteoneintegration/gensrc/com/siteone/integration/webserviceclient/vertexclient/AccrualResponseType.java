 ...
 * 
 * <p>Java class for AccrualResponseType complex type</p>.
 * 
    ...
    extends TaxTransactionResponseType
{
    ...
    /**
     * An identifier that determines the point in which the title transfer and risk of a supply takes place. A Delivery Term Code identifies the importer of record on cross-border transactions. These terms are also known as Shipping Terms or Incoterm. Delivery Term information is critical in Value Added Tax transactions to determine the place ofsupply, for example, in distance selling. For detailed explanations of these terms, refer to the Terms of Sales definition in the glossary of the U.S. Department of Transportation Maritime
     * Administration Web site at http://www.marad.dot.gov/publications/glossary/T.html.
     * 
     */
    ...
    /**
     * When set to TRUE, this indicator causes the vendor-charged liability to be processed when determining the buyer's self-accrual liability.
     * 
     */
     ...
     *     {@link Boolean }
     *     
     * @see #isCalculateVendorTaxIndicator()
     */
